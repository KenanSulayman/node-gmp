...
assert.ok(2.20e99 < new gmp.Int("2233445598765432112345678909876543212345728034872035834572034572803457802435728034578023457023580243.2").toValue());
assert.ok(2.30e99 > new gmp.Int("2233445598765432112345678909876543212345728034872035834572034572803457802435728034578023457023580243.2").toValue());
...
assert.equal(5, new gmp.Float("25").sqrt().toValue());
assert.equal(11, new gmp.Float("10.001").ceil().toValue());

// new gmp.Float(-1).sqrt(); // This breaks on Mac.
